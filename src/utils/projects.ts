...
export const projects: Projects[] = [
    {
        ...
        open: false,
        private: true,
        description: 'Se requeria un control de cobranza de mensualidades de colegiaturas de alumnos, el cual contemplara todas las caracteristicas de un control escolar, becas, descuentos y recargos.'
    },
    {
