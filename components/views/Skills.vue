<template>
  <v-container>
    <v-row dense>
      ...
      <v-col
          v-for="(item, i) in state.languages"
          :key="i"
        ...
        >
          <v-card-text>
            ...
            >
              ...
              <div style="position: absolute" class="pt-12">
                {{ item.percentage + ' %' }}
              </div>
            </v-progress-circular>
  ...
  setup() {
    const state = reactive({
      skills: [
        ...
        {
          color: '#41CD52',
          src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Qt_logo_2016.svg/1200px-Qt_logo_2016.svg.png',
          title: 'QT',
          percentage: 30,
        },
      ],
